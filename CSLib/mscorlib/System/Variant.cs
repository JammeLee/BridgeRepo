	...
	internal struct Variant
	{
		...
		internal static void MarshalHelperConvertObjectToVariant(object o, ref Variant v)
		{
			...
			case TypeCode.String:
				...
				break;
			default:
				throw new NotSupportedException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("NotSupported_UnknownTypeCode"), convertible.GetTypeCode()));
			}
		}
