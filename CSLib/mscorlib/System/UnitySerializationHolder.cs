	...
	internal class UnitySerializationHolder : ISerializable, IObjectReference
	{
		...
		public virtual object GetRealObject(StreamingContext context)
		{
			...
			case 5:
			{
				...
				if (module == null)
				{
					throw new SerializationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_UnableToFindModule"), m_data, m_assemblyName));
				}
				return module;
			}
			case 6:
