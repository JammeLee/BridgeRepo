...
namespace System.Security.AccessControl
{
	public abstract class GenericSecurityDescriptor
	{
		...
		internal abstract GenericAcl GenericSacl
		{
			get;
		}

		internal abstract GenericAcl GenericDacl
		{
			get;
		}
		...
		public void GetBinaryForm(byte[] binaryForm, int offset)
		{
			...
			_ = BinaryLength;
			byte b = (byte)((this is RawSecurityDescriptor && (ControlFlags & ControlFlags.RMControlValid) != 0) ? (this as RawSecurityDescriptor).ResourceManagerControl : 0);
