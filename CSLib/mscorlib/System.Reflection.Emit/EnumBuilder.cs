...
namespace System.Reflection.Emit
{
	...
	public sealed class EnumBuilder : Type, _EnumBuilder
	{
		...
		public override Type UnderlyingSystemType => m_underlyingType;
		...
		internal override int MetadataTokenInternal => m_typeBuilder.MetadataTokenInternal;
		...
		internal EnumBuilder(string name, Type underlyingType, TypeAttributes visibility, Module module)
		{
			...
			m_typeBuilder = new TypeBuilder(name, visibility | TypeAttributes.Sealed, typeof(Enum), null, module, PackingSize.Unspecified, null);
