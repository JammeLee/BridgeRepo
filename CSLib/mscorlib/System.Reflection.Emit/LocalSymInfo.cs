...
namespace System.Reflection.Emit
{
	internal class LocalSymInfo
	{
		...
		private void EnsureCapacityNamespace()
		{
			...
			{
				string[] array = new string[m_iNameSpaceCount * 2];
