...
namespace System.Runtime.Remoting
{
	internal class Identity
	{
		...
		internal ObjRef ObjectRef => (ObjRef)_objRef;
		...
		internal void SetOrCreateURI(string uri, bool bIdCtor)
		{
			...
			if (uri == null)
			{
				...
				_ObjURI = (IDGuidString + text.Replace('/', '_') + "_" + GetNextSeqNum() + ".rem").ToLower(CultureInfo.InvariantCulture);
			}
		...
		internal virtual void AssertValid()
		{
			if (URI != null)
			{
				IdentityHolder.ResolveIdentity(URI);
			}
		}
