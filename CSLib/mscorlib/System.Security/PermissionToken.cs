...
namespace System.Security
{
	...
	internal sealed class PermissionToken : ISecurityEncodable
	{
		...
		private static ReflectionPermission s_reflectPerm;
		...
		public static PermissionToken GetToken(Type cls)
		{
			...
			if (cls.GetInterface("System.Security.Permissions.IBuiltInPermission") != null)
			{
				...
				int index = (int)runtimeMethodInfo.Invoke(null, BindingFlags.Default, null, null, null, skipVisibilityChecks: true);
		...
		public SecurityElement ToXml()
		{
			...
			{
				securityElement.AddAttribute("Index", "" + m_index);
			}
			else
			{
