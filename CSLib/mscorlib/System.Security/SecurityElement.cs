	...
	public sealed class SecurityElement : ISecurityElementFactory
	{
		...
		public Hashtable Attributes
		{
			get
			{
				...
				Hashtable hashtable = new Hashtable(m_lAttributes.Count);
		...
		internal void ConvertSecurityElementFactories()
		{
			...
			{
				ISecurityElementFactory securityElementFactory = m_lChildren[i] as ISecurityElementFactory;
				if (securityElementFactory != null && !(m_lChildren[i] is SecurityElement))
				{
		...
		{
			string strTag;
			if ((strTag = m_strTag) != null && strTag == "PermissionSet")
			{
