	...
	public class ServerChannelSinkStack : IServerChannelSinkStack, IServerResponseChannelSinkStack
	{
		...
		public void ServerCallback(IAsyncResult ar)
		{
			if (_asyncEnd != null)
			{
				...
				object[] outArgs;
				object ret = stackBuilderSink.PrivateProcessMessage(_asyncEnd.MethodHandle, Message.CoerceArgs(_asyncEnd, array, parameters), _serverObject, 0, fExecuteInContext: false, out outArgs);
				if (outArgs != null)
				{
				...
				IMessage msg = new ReturnMessage(ret, outArgs, _msg.ArgCount, CallContext.GetLogicalCallContext(), _msg);
