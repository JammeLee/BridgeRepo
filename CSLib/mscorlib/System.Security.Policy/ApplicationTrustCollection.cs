...
namespace System.Security.Policy
{
	...
	public sealed class ApplicationTrustCollection : ICollection, IEnumerable
	{
		...
		public int Count => AppTrusts.Count;

		public ApplicationTrust this[int index] => AppTrusts[index] as ApplicationTrust;
		...
		private void CommitApplicationTrust(ApplicationIdentity applicationIdentity, string trustXml)
		{
			...
			definitionAppId.SetAppPath(1u, new IDefinitionIdentity[1]
			{
				definitionIdentity
			});
