	...
	public abstract class CodeGroup
	{
		...
		public IList Children
		{
			...
			set
			{
				...
				while (enumerator.MoveNext())
				{
					CodeGroup codeGroup = enumerator.Current as CodeGroup;
					if (codeGroup == null)
					{
		...
		public virtual string PermissionSetName
		{
			get
			{
				...
				return (m_policy.GetPermissionSetNoCopy() as NamedPermissionSet)?.Name;
			}
		}
		...
		public override bool Equals(object o)
		{
			...
			if (codeGroup != null && GetType().Equals(codeGroup.GetType()) && object.Equals(m_name, codeGroup.m_name) && object.Equals(m_description, codeGroup.m_description))
			{
				if (m_membershipCondition == null && m_element != null)
				{
					ParseMembershipCondition();
