				...
				if (num2 != 0 || chars < ptr)
				{
					if (c2 == '\0')
					{
						if (!bigEndian && c == '\0' && ((int)chars & 3) == 0)
						{
							...
							{
								if ((0x8000800080008000uL & *ptr3) != 0)
								{
									ulong num3 = (0xD800D800D800D800uL & *ptr3) ^ 0xD800D800D800D800uL;
									if (((num3 & 0xFFFF000000000000uL) == 0 || (num3 & 0xFFFF00000000L) == 0 || (num3 & 0xFFFF0000u) == 0 || (num3 & 0xFFFF) == 0) && ((0xDC00DC00DC00DC00uL & *ptr3) ^ 0xDC00D800DC00D800uL) != 0)
									{
										break;
									}
								}
				...
				if (num != 0 || chars < ptr2)
				{
					if (c2 == '\0')
					{
						if (!bigEndian && ((int)chars & 3) == 0 && ((int)bytes & 3) == 0 && c == '\0')
						{
							...
							while (ptr6 < ptr5)
							{
								if ((0x8000800080008000uL & *ptr6) != 0)
								{
									ulong num2 = (0xD800D800D800D800uL & *ptr6) ^ 0xD800D800D800D800uL;
									if (((num2 & 0xFFFF000000000000uL) == 0 || (num2 & 0xFFFF00000000L) == 0 || (num2 & 0xFFFF0000u) == 0 || (num2 & 0xFFFF) == 0) && ((0xDC00DC00DC00DC00uL & *ptr6) ^ 0xDC00D800DC00D800uL) != 0)
									{
										break;
									}
								}
