...
namespace System.Security.Permissions
{
	...
	public sealed class StrongNameIdentityPermission : CodeAccessPermission, IBuiltInPermission
	{
		...
		public override IPermission Intersect(IPermission target)
		{
			...
			strongNameIdentityPermission3.m_strongNames = (StrongName2[])arrayList.ToArray(typeof(StrongName2));
		...
		public override IPermission Union(IPermission target)
		{
			...
			ArrayList arrayList = new ArrayList();
			StrongName2[] strongNames = m_strongNames;
			foreach (StrongName2 value in strongNames)
			{
				arrayList.Add(value);
			}
			StrongName2[] strongNames2 = strongNameIdentityPermission.m_strongNames;
			...
			{
				bool flag = false;
				foreach (StrongName2 item in arrayList)
				{
					if (strongName.Equals(item))
					{
						flag = true;
						break;
					}
		...
		public override void FromXml(SecurityElement e)
		{
			...
			if (children != null)
			{
				...
				{
					text2 = item.Attribute("PublicKeyBlob");
					text3 = item.Attribute("Name");
					text4 = item.Attribute("AssemblyVersion");
					if (text2 != null || text3 != null || text4 != null)
					{
						StrongName2 value = new StrongName2((text2 == null) ? null : new StrongNamePublicKeyBlob(text2), text3, (text4 == null) ? null : new Version(text4));
						arrayList.Add(value);
