...
namespace System.Runtime.InteropServices.TCEAdapterGen
{
	internal class EventSinkHelperWriter
	{
		...
		public Type Perform()
		{
			...
			string str = null;
			string text = NameSpaceExtractor.ExtractNameSpace(m_EventItfType.FullName);
			if (text != "")
			{
				str = text + ".";
			}
			str = str + m_InputType.Name + GeneratedTypeNamePostfix;
			TypeBuilder typeBuilder = TCEAdapterGenerator.DefineUniqueType(str, TypeAttributes.Public | TypeAttributes.Sealed, null, aInterfaceTypes, m_OutputModule);
