...
namespace System.Runtime.Serialization.Formatters.Binary
{
	internal sealed class SerializationHeaderRecord : IStreamable
	{
		...
		public void Read(__BinaryParser input)
		{
			...
			{
				throw new SerializationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_InvalidFormat"), BitConverter.ToString(array)));
			}
