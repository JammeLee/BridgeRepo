...
namespace System.Net.Sockets
{
	public class UdpClient : IDisposable
	{
		...
		public UdpClient(AddressFamily family)
		{
			...
			{
				throw new ArgumentException(SR.GetString("net_protocol_invalid_family", "UDP"), "family");
			}
			m_Family = family;
			createClientSocket();
		}
		...
		public void JoinMulticastGroup(IPAddress multicastAddr)
		{
			...
			{
				throw new ArgumentException(SR.GetString("net_protocol_invalid_multicast_family", "UDP"), "multicastAddr");
			}
