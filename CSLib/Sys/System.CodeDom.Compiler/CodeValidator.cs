...
namespace System.CodeDom.Compiler
{
	...
	{
		private static readonly char[] newLineChars = new char[5]
		{
			'\r',
			'\n',
			'\u2028',
		...
		private static void ValidateTypeName(object e, string propertyName, string typeName)
		{
			...
			{
				string @string = SR.GetString("InvalidTypeName", typeName, propertyName, e.GetType().FullName);
		...
		private static void ValidateIdentifier(object e, string propertyName, string identifier)
		{
			...
			{
				string @string = SR.GetString("InvalidLanguageIdentifier", identifier, propertyName, e.GetType().FullName);
