...
namespace System.ComponentModel
{
	...
	public class TypeConverter
	{
		...
		{
			string text = ((value != null) ? value.GetType().FullName : SR.GetString("ToStringNull"));
			throw new NotSupportedException(SR.GetString("ConvertFromException", GetType().Name, text));
		}

		protected Exception GetConvertToException(object value, Type destinationType)
		{
			string text = ((value != null) ? value.GetType().FullName : SR.GetString("ToStringNull"));
			throw new NotSupportedException(SR.GetString("ConvertToException", GetType().Name, text, destinationType.FullName));
		}
