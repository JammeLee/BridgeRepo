	...
	public class EnumConverter : TypeConverter
	{
		...
		public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
		{
			if (value is string)
			{
				...
				{
					throw new FormatException(SR.GetString("ConvertInvalidPrimitive", (string)value, type.Name), innerException);
				}
			}
			if (value is Enum[])
			{
		...
		public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
		{
			...
			if (destinationType == typeof(string) && value != null)
			{
				...
				{
					throw new ArgumentException(SR.GetString("EnumConverterInvalidValue", value.ToString(), type.Name));
				}
			...
			if (destinationType == typeof(Enum[]) && value != null)
			{
				if (type.IsDefined(typeof(FlagsAttribute), inherit: false))
				{
					...
					while (flag)
					{
						...
						{
							if ((num2 != 0 && (num2 & num) == num2) || num2 == num)
							{
