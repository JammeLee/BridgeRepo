...
namespace System.Net
{
	internal class CredentialHostKey
	{
		...
		public override bool Equals(object comparand)
		{
			...
			return string.Compare(AuthenticationType, credentialHostKey.AuthenticationType, StringComparison.OrdinalIgnoreCase) == 0 && string.Compare(Host, credentialHostKey.Host, StringComparison.OrdinalIgnoreCase) == 0 && Port == credentialHostKey.Port;
		}
