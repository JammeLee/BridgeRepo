...
namespace System.Net
{
	internal static class ExceptionHelper
	{
		...
		internal static UriFormatException BadSchemeException => new UriFormatException(SR.GetString("net_uri_BadScheme"));

		internal static UriFormatException BadAuthorityException => new UriFormatException(SR.GetString("net_uri_BadAuthority"));

		internal static UriFormatException EmptyUriException => new UriFormatException(SR.GetString("net_uri_EmptyUri"));

		internal static UriFormatException SchemeLimitException => new UriFormatException(SR.GetString("net_uri_SchemeLimit"));

		internal static UriFormatException SizeLimitException => new UriFormatException(SR.GetString("net_uri_SizeLimit"));

		internal static UriFormatException MustRootedPathException => new UriFormatException(SR.GetString("net_uri_MustRootedPath"));

		internal static UriFormatException BadHostNameException => new UriFormatException(SR.GetString("net_uri_BadHostName"));

		internal static UriFormatException BadPortException => new UriFormatException(SR.GetString("net_uri_BadPort"));

		internal static UriFormatException BadAuthorityTerminatorException => new UriFormatException(SR.GetString("net_uri_BadAuthorityTerminator"));

		internal static UriFormatException BadFormatException => new UriFormatException(SR.GetString("net_uri_BadFormat"));

		internal static UriFormatException CannotCreateRelativeException => new UriFormatException(SR.GetString("net_uri_CannotCreateRelative"));
