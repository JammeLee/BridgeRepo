	...
	public sealed class WebPermissionAttribute : CodeAccessSecurityAttribute
	{
		...
		public string Connect
		{
			...
			set
			{
				if (m_connect != null)
				{
					throw new ArgumentException(SR.GetString("net_perm_attrib_multi", "Connect", value), "value");
				}
				m_connect = value;
			}
		}
		...
		public string Accept
		{
			...
			set
			{
				if (m_accept != null)
				{
					throw new ArgumentException(SR.GetString("net_perm_attrib_multi", "Accept", value), "value");
				}
				m_accept = value;
			}
		}
		...
		public string ConnectPattern
		{
			...
			set
			{
				if (m_connect != null)
				{
					throw new ArgumentException(SR.GetString("net_perm_attrib_multi", "ConnectPatern", value), "value");
				}
				if (value == ".*")
				{
					m_connect = true;
		...
		public string AcceptPattern
		{
			...
			set
			{
				if (m_accept != null)
				{
					throw new ArgumentException(SR.GetString("net_perm_attrib_multi", "AcceptPattern", value), "value");
				}
				if (value == ".*")
				{
					m_accept = true;
