...
namespace System.Net
{
	internal class CredentialKey
	{
		...
		public override bool Equals(object comparand)
		{
			...
			return string.Compare(AuthenticationType, credentialKey.AuthenticationType, StringComparison.OrdinalIgnoreCase) == 0 && UriPrefix.Equals(credentialKey.UriPrefix);
		}
