...
namespace Microsoft.Win32
{
	...
	internal static class NativeMethods
	{
		...
		internal class STARTUPINFO
		{
			...
			public SafeFileHandle hStdInput = new SafeFileHandle(IntPtr.Zero, ownsHandle: false);

			public SafeFileHandle hStdOutput = new SafeFileHandle(IntPtr.Zero, ownsHandle: false);

			public SafeFileHandle hStdError = new SafeFileHandle(IntPtr.Zero, ownsHandle: false);
		...
		public const int ENDSESSION_LOGOFF = int.MinValue;
		...
		public const int TH32CS_INHERIT = int.MinValue;
		...
		public static extern int WaitForSingleObject(Microsoft.Win32.SafeHandles.SafeProcessHandle handle, int timeout);
		...
		public static extern bool CreateProcessAsUser(SafeHandle hToken, string lpApplicationName, string lpCommandLine, SECURITY_ATTRIBUTES lpProcessAttributes, SECURITY_ATTRIBUTES lpThreadAttributes, bool bInheritHandles, int dwCreationFlags, HandleRef lpEnvironment, string lpCurrentDirectory, STARTUPINFO lpStartupInfo, SafeNativeMethods.PROCESS_INFORMATION lpProcessInformation);
