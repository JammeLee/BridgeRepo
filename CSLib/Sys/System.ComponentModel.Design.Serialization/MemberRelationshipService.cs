	...
	public abstract class MemberRelationshipService
	{
		private struct RelationshipEntry
		{
			...
			public override bool Equals(object o)
			{
				...
				{
					RelationshipEntry re = (RelationshipEntry)o;
					return this == re;
				}
				return false;
			}
		...
		protected virtual void SetRelationship(MemberRelationship source, MemberRelationship relationship)
		{
			if (!relationship.IsEmpty && !SupportsRelationship(source, relationship))
			{
				...
				throw new ArgumentException(SR.GetString("MemberRelationshipService_RelationshipNotSupported", text, source.Member.Name, text2, relationship.Member.Name));
			}
